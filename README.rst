...
A Python implementation of various metrics (primarily external) used for clustering evaluation. The documentation is available online at `clustring-metrics-docs <https://escherba.github.io/clustering-metrics/>`_
