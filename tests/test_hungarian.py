...
class HungaritanTest(unittest.TestCase):
    ...
    def test_assignment_score(self):
        for cost_matrix, expected_cost in [
            ...
            assert score == expected_sum
            assert score_T == expected_sum
            ...
            self.assertAlmostEqual(score_dbl, float(expected_sum))
            self.assertAlmostEqual(score_T_dbl, float(expected_sum))


    def test_linear_sum_assignment_input_validation(self):
