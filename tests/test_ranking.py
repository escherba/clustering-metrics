...
class TestRanking(unittest.TestCase):
    ...
    def test_simulated(self):
        ...
        for _ in range(100):
            ...
            self.assertAlmostEqual(expected_score, actual_score, 4)
    ...
    def test_roc_simulated(self):
        ...
        for _ in range(10):
            ...
            self.assertAlmostEqual(auc_expected1, auc_actual, 3)
            self.assertAlmostEqual(auc_expected2, auc_actual, 3)


    def test_roc_precalculated_t2(self):
        ...
        auc = rc.auc_score()
        self.assertAlmostEqual(auc, 0.875, 3)


    def test_roc_precalculated_t4(self):
        ...
        auc = rc.auc_score()
        self.assertAlmostEqual(auc, 0.839, 3)
    ...
    def test_sample_empty(self):
        ...
        self.assertAlmostEqual(score1, 0.0, 4)
        self.assertAlmostEqual(score2, 0.0, 4)


    def test_sample_perfect(self):
        """Perfect clustering
        """
        ...
        self.assertAlmostEqual(aul1, 1.0, 4)
        self.assertAlmostEqual(aul2, 1.0, 4)

        auc = RocCurve.from_clusters(clusters).auc_score()
        self.assertAlmostEqual(auc, 1.0, 4)


    def test_sample_class1_nh(self):
        ...
        aul1 = aul_score_from_labels(*clusters_to_labels(clusters))
        aul2 = aul_score_from_clusters(clusters)
        self.assertAlmostEqual(aul1, 0.8286, 4)
        self.assertAlmostEqual(aul2, 0.8286, 4)

        auc = RocCurve.from_clusters(clusters).auc_score()
        self.assertAlmostEqual(auc, 1.0, 4)


    def test_sample_cluster0_nh(self):
        ...
        aul1 = aul_score_from_labels(*clusters_to_labels(clusters))
        aul2 = aul_score_from_clusters(clusters)
        self.assertAlmostEqual(aul1, 0.8, 4)
        self.assertAlmostEqual(aul2, 0.8, 4)

        auc = RocCurve.from_clusters(clusters).auc_score()
        self.assertAlmostEqual(auc, 0.8333, 4)


    def test_sample_cluster0_c0(self):
        ...
        aul1 = aul_score_from_labels(*clusters_to_labels(clusters))
        aul2 = aul_score_from_clusters(clusters)
        self.assertAlmostEqual(aul1, 0.6667, 4)
        self.assertAlmostEqual(aul2, 0.6667, 4)

        auc = RocCurve.from_clusters(clusters).auc_score()
        self.assertAlmostEqual(auc, 1.0, 4)


    def test_sample_neg_class1(self):
        ...
        aul1 = aul_score_from_labels(*clusters_to_labels(clusters))
        aul2 = aul_score_from_clusters(clusters)
        self.assertAlmostEqual(aul1, 0.8690, 4)
        self.assertAlmostEqual(aul2, 0.8690, 4)

        auc = RocCurve.from_clusters(clusters).auc_score()
        self.assertAlmostEqual(auc, 0.9167, 4)
    ...
    def test_sample_bad(self):
        ...
        aul1 = aul_score_from_labels(*clusters_to_labels(clusters))
        aul2 = aul_score_from_clusters(clusters)
        self.assertAlmostEqual(aul1, 0.5, 4)
        self.assertAlmostEqual(aul2, 0.5, 4)

        auc = RocCurve.from_clusters(clusters).auc_score()
        self.assertAlmostEqual(auc, 0.6667, 4)


    def test_sample_perverse(self):
        ...
        aul1 = aul_score_from_labels(*clusters_to_labels(clusters))
        aul2 = aul_score_from_clusters(clusters)
        self.assertAlmostEqual(aul1, 0.1111, 4)
        self.assertAlmostEqual(aul2, 0.1111, 4)

        auc = RocCurve.from_clusters(clusters).auc_score()
        self.assertAlmostEqual(auc, 0.0, 4)
    ...
    def test_scores_2(self):
        ...
        auc = dist_auc(scores0, scores1)
        self.assertAlmostEqual(auc, 0.9375, 4)
    ...
    def test_scores_3(self):
        ...
        scores1 = [nan, 40, 50, 60]
        auc = dist_auc(scores0, scores1)
        self.assertAlmostEqual(auc, 0.875, 4)
    ...
    def test_scores_4(self):
        ...
        scores1 = [nan, 40, 50, 60]
        auc = dist_auc(scores0, scores1)
        self.assertAlmostEqual(auc, 0.8646, 4)
    ...
    def test_scores_5(self):
        ...
        scores1 = [25, 40, 50, 60]
        auc = dist_auc(scores0, scores1)
        self.assertAlmostEqual(auc, 0.8125, 4)
